...
class Data_Layer_train(caffe.Layer):
    def setup(self, bottom, top):
        ...
        net_side = 64
        roi_list = ''
#        roi_root = '/Users/momo/wkspace/caffe_space/detection/caffe/data/0926reg64/'
#        roi_txt='/Users/momo/wkspace/caffe_space/detection/caffe/data/0926reg64/trains.txt'
        roi_root = '/Users/momo/wkspace/caffe_space/detection/caffe/data/0927edge/'
        roi_txt='/Users/momo/wkspace/caffe_space/detection/caffe/data/0927edge/trains.txt'
        print roi_txt
        self.batch_loader = BatchLoader(roi_list,net_side,roi_root,roi_txt)
        top[0].reshape(self.batch_size, 3, net_side, net_side)
        top[1].reshape(self.batch_size, 4)
