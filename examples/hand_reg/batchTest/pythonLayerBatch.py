...
class Data_Layer_test(caffe.Layer):
    def setup(self, bottom, top):
        ...
        self.batch_size = 128
        self.roi_list = []
        self.roi_root = '//nfs/zhengmeisong/wkspace/gesture/caffe/data/regData/1030data/trainIMDB/'
...
class Data_Layer_train(caffe.Layer):
    def setup(self, bottom, top):
        ...
        self.roi_list = ''
        self.roi_root = '/nfs/zhengmeisong/wkspace/gesture/caffe/data/regData/1030data/trainIMDB/'
        self.roi_txt='/nfs/zhengmeisong/wkspace/gesture/caffe/data/regData/1030data/trainIMDB.txt'
        print self.roi_txt
        sys.stdout.flush()
        self.batch_loader = BatchLoader(self.roi_list,self.roi_root,self.roi_txt)
        top[0].reshape(self.batch_size, 3, net_side, net_side)
