...
class Data_Layer_test(caffe.Layer):
    def setup(self, bottom, top):
        ...
        self.batch_size = 128
        self.roi_list = []
        self.roi_root = '//nfs/zhengmeisong/wkspace/gesture/caffe/data/128regData/1115data/testIMDB/'
        self.roi_txt='/nfs/zhengmeisong/wkspace/gesture/caffe/data/128regData/1115data/testIMDB.txt'
        print self.roi_txt
        sys.stdout.flush()
    ...
    def forward(self, bottom, top):
        ...
        fid.close()
        print "read a batch took:",time.time() - start_time
        sys.stdout.flush()
...
class Data_Layer_train(caffe.Layer):
    def setup(self, bottom, top):
        ...
        self.batch_size = 128
        self.roi_list = ''
        self.roi_root = '/nfs/zhengmeisong/wkspace/gesture/caffe/data/128regData/1115data/trainIMDB/'
        self.roi_txt='/nfs/zhengmeisong/wkspace/gesture/caffe/data/128regData/1115data/trainIMDB.txt'
        print self.roi_txt
        sys.stdout.flush()
        self.batch_loader = BatchLoader(self.roi_list,self.roi_root,self.roi_txt)
        top[0].reshape(self.batch_size, 3, net_side, net_side)
