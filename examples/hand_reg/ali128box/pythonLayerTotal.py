...
class Data_Layer_test(caffe.Layer):
    def setup(self, bottom, top):
        ...
        net_side = 128
        roi_list = []
        roi_root = '/nfs/zhengmeisong/wkspace/gesture/caffe/data/128regData/1115data/'
        roi_txt='//nfs/zhengmeisong/wkspace/gesture/caffe/data/128regData/1115data/test.txt'
...
class Data_Layer_train(caffe.Layer):
	...
	roi_list = ''
	roi_root = '/nfs/zhengmeisong/wkspace/gesture/caffe/data/128regData/1115data/'
        roi_txt='/nfs/zhengmeisong/wkspace/gesture/caffe/data/128regData/1115data/train30w.txt'
        self.batch_loader = BatchLoader(roi_list,net_side,roi_root,roi_txt)
        top[0].reshape(self.batch_size, 3, net_side, net_side)
	top[1].reshape(self.batch_size, 4)
    def reshape(self, bottom, top):
