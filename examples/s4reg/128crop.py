...
#anno_file = "gt/T_5_five_pink.txt"
#anno_file = "gt/T_3_one_pink.txt"
#anno_file = "gt/T_13_fist_pink.txt"
#anno_file = "gt/T-15-palm-total.txt"
#anno_file = "gt/Tight_green_nofist.txt"
to_dir = "/nfs/zhengmeisong/wkspace/gesture/caffe/data/128regData/1115data/"
...
num = len(annotations)
print anno_file, "%d pics in total" % num, "%d needed" % maxNum
