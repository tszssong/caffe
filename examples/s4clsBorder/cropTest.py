...
numclslists = []
for cls_idx in range(len(clslists)):
    numclslists.append(0)
print np.min(numclslists), len(numclslists)
...
idx = 0
box_idx = 0
while np.min(numclslists[1:]) < maxNum:
