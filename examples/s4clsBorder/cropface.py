...
from_dir = "/Volumes/song2t/face/TrainData/2829/0328/JPEGImages/"
anno_file = "/Users/momo/wkspace/caffe_space/caffe/examples/s4cls/gt/0-face-0328.txt"
    ...
    for pic_idx in range(N_ROT):
        ...
        for box_idx in xrange(f_boxes.shape[0]):
            ...
            for i in range(N_RESIZE):
                ...
                nx2 = ncx + nw / 2
                ny2 = ncy + nh / 2
                #loser constant than hand train data
                if nx2 < rx2 - 20 or nx1 > rx1 + 20 or ny2 < ry2 - 20 or ny1 > ry1 + 20:
                    continue
