...
train_proto = 'get_box_symbol.prototxt'
train_model = 'only7_4_6iter34w.caffemodel'  #should be your snapshot caffemodel

deploy_proto = 'box_mergebn.prototxt'
save_model = 'bbox_deploy.caffemodel'
...
#            if key.endswith("_bn") or key.endswith("_scale"):
            if "_bn" in key or "_scale" in key:
		continue
            else:
                conv = net.params[key]
