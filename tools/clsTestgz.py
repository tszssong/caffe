...
#                            "models/mouth48_1011/1011_48_iter_1100000.caffemodel", caffe.TEST)
#    classify_net = caffe.Net("examples/hand_cls/mouth48/test14cls.prototxt", "models/gz/14cls_iter_50000.caffemodel", caffe.TEST)
    classify_net = caffe.Net("examples/hand_cls/mouth48/test14cls.prototxt", "models/gz/14cls_iter_78000.caffemodel", caffe.TEST)
