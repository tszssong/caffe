...
import numpy as np
logfilelist = [
               "/Users/momo/wkspace/caffe_space/detection/caffe/examples/hand_reg/mouthmac/log/2018-11-14_10-01-33.log", \
               "/Users/momo/wkspace/caffe_space/detection/caffe/examples/hand_reg/mouthmac/log/2018-11-09_09-30-22.log"
               ]
...
def get_lr_loss( logfile ):
    ...
    print "average train loss:", np.average(train_reg_loss)
    print "average test loss:", np.average(test_reg_loss)
